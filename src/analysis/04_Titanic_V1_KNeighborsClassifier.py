...
param_grid = [{'reduce_dim__n_components': [5, 8],
               'classification__n_neighbors': [2, 5, 10],
               'classification__leaf_size': [20, 30, 50],
...
train_errors = evaluate_pipe_best_train(x_train, y_train, pipe_best, 'KNeighborsClassifier')
